        ...
        <table id="menu">
            ...
            foreach ($orders2 as $key => $value) {
                ...
                <td>
                    ...
                    <a class = 'unfriend' href='adminorderdetailpage.php?orderId=" . $value->getId() . "'>View</a>
                    <a class = 'unfriend' href='admininvoicedetailpage.php?orderId=" . $value->getId() . "'>Invoice</a>
                </td>          
            </tr>";
            }
            ?>
